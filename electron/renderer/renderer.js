                    ...
                    if (viewer.parsedDxf?.entities?.length > 0) {
                        ...
                        layerEntities.forEach(entity => {
                            ...
                            if (entity.color !== undefined && entity.color !== null) {
                                ...
                                console.log(`Entity ${entityType} on layer ${layerName} has color: ${entity.color} (hex: ${colorHex})`);
                            } else {
                                console.log(`Entity ${entityType} on layer ${layerName} has NO color information`);
                            }
                        });
